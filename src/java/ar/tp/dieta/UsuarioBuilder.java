...
public class UsuarioBuilder {
  ...
  public UsuarioBuilder(final String nombreUsuario) {
  ...
  public UsuarioBuilder conRecetaFavorita(final Receta unaReceta) {
    this.usuario.agregarRecetaFavorita(unaReceta);
    return this;
  }
  
  public UsuarioBuilder conPassword(final String unPass) {
    this.usuario.setPassword(unPass);
    return this;
  }
