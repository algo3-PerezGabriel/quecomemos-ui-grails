...
public class FiltroPorTemporada implements Filtro {
  ...
  public FiltroPorTemporada(final String unaTemporada) {
  ...
  public List<Receta> aplicarFiltroUsuario(final Usuario unUsuario, final List<Receta> recetasSinFiltrar) {
    ...
    boolean _equals = Objects.equal(this.temporada, null);
    if (_equals) {
      ...
      final Function1<Receta, Boolean> _function = new Function1<Receta, Boolean>() {
        public Boolean apply(final Receta it) {
          String _temporadaALaQueCorresponde = it.getTemporadaALaQueCorresponde();
          return Boolean.valueOf(_temporadaALaQueCorresponde.equals(FiltroPorTemporada.this.temporada));
        }
      };
