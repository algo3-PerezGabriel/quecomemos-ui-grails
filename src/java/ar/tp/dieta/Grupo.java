...
public class Grupo extends Miembro {
  ...
  public Receta copiarReceta(final Usuario unUsuario, final Grupo unGrupo, final Receta unaReceta, final String nombreReceta) {
    Receta _xblockexpression = null;
    {
      ...
      int _calorias = recetaTemporal.getCalorias();
      ...
      ArrayList<ElementoDeReceta> _elementosDeReceta = recetaTemporal.getElementosDeReceta();
      ArrayList<ElementoDeReceta> _arrayList = new ArrayList<ElementoDeReceta>(_elementosDeReceta);
      unaReceta.setElementosDeReceta(_arrayList);
  ...
  public List<Receta> devolverRecetas() {
    List<Receta> _xblockexpression = null;
    {
      ...
      recetasDeGrupo.addAll(this.recetario.recetas);
